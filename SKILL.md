...
**版本**: v1.1.0 (新增宏观过滤 v1.0)
**核心理念**: 控制论负反馈 (Negative Feedback Loop) + 宏观环境映射 (Macro Regime Mapping)
**作者**: Atlas (GroAries)
...
### 🆕 v1.1 新增：全球宏观联动过滤器 (Global Macro Filter)
在微观策略共振之前，增加一层**宏观环境评估**。
*   **逻辑**: 宏观是天气，策略是种子。暴雨天 (Risk-Off) 不播种，晴朗天 (Risk-On) 加大仓位。
*   **监控指标**: 美债 10Y (流动性)、VIX (恐慌)、地缘政治状态。
*   **核心输出**: 建议最大仓位 (`Max_Position_Cap`)。
